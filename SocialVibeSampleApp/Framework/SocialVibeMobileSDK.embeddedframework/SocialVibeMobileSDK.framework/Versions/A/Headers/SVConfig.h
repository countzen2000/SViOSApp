...
// The keywords parameter should be an array of NSString objects.
...
// The gender parameter should be either "m" or "f".
// The country parameter should be the ISO-3166-1 Alpha-3 value.
// The keywords parameter should be an array of NSString objects.
