...
(function() {
  ...
  var mraid_ext = window.mraid_ext = {};
  ...
  mraid_ext.start = function() {
    bridge.executeNativeCall('start');
  };
 
  mraid_ext.credit = function(params) {
    payload = params['payload'];
    signature = params['signature'];
    bridge.executeNativeCall('credit', 'payload', payload, 'signature', signature);
  };
 
  mraid_ext.finish = function() {
    bridge.executeNativeCall('finish');
  };
 
  mraid_ext.localNotification = function(params) {
     fireDate = params['fireDate'];
     promptText = params['promptText'];
     notifText = params['notifText'];
     url = params['URL'];
     bridge.executeNativeCall('localnotification', 'fireDate', fireDate, 'promptText', promptText, 'notifText', notifText, 'url', url);
  };
 
  mraid_ext.passbook = function(params) {
     URL = params['URL'];
     bridge.executeNativeCall('passbook', 'url', URL);
  };
